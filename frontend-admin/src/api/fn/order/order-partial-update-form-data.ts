...
export function orderPartialUpdate$FormData(http: HttpClient, rootUrl: string, params: OrderPartialUpdate$FormData$Params, context?: HttpContext): Observable<StrictHttpResponse<Order>> {
