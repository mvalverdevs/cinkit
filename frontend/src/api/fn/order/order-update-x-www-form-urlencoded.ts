...
export function orderUpdate$XWwwFormUrlencoded(http: HttpClient, rootUrl: string, params: OrderUpdate$XWwwFormUrlencoded$Params, context?: HttpContext): Observable<StrictHttpResponse<Ordererializer>> {
