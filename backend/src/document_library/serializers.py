...
class DocumentLibrarySerializer(DynamicModelSerializer, WritableNestedModelSerializer):
    ...
    document = serializers.FileField(default=None)
    description = serializers.CharField(default="")
    type_license = serializers.CharField(default=doc_constants.LICENSE0)
...
class DocumentLibraryCreateSerializer(DynamicModelSerializer, WritableNestedModelSerializer):
    ...
    class Meta:
        model = DocumentLibrary
        fields = ('id', 'name', 'document', 'title', 'author', 'type_license', 'description', 'expiry_date', 'visible',
                  'category')
